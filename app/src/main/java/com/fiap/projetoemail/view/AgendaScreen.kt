...
@Composable
fun AgendaScreen(navControler: NavController) {
    ...
    Column(
        ...
        Row(
            ...
            StyledButton(
                text = "Marcar Evento",
                onClick = { navControler.navigate("MarcarEventosScreen") },
            ...
            StyledButton(
                ...
                onClick = { navControler.navigate("EventosMarcadosScreen") },
